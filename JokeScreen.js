  ...
  render() {
    return (
      <View>
        ...
        <Image style={styles.img} source={require('../assets/joke1.png')} />
        <Text style={styles.text}>Scene of maths class :-</Text>
        <Image style={styles.img} source={require('../assets/joke2.png')} />
        <Text style={styles.text}>Moral values :-</Text>
        <Image style={styles.img} source={require('../assets/joke3.png')} />
      </View>
    );
  }
}
